...
from openaipro.api_resources import (
    Completion,
    Customer,
    Edit,
    Deployment,
...
from openaipro.error import APIError, InvalidRequestError, OpenAIError
...
api_base = os.environ.get("OPENAI_API_BASE", "https://openaipro-api.tedx.net/v1")
